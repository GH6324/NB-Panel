...
| 脚本 | 说明 | 一键命令 |
|------|------|----------|
| [`install.sh`](scripts/install.sh) | 二进制部署 → systemd 服务 | `bash <(wget -qO- https://raw.githubusercontent.com/lima-droid/NB-Panel/main/scripts/install.sh)` |
| [`install2.sh`](scripts/install2.sh) | 安装时可选 **二进制** 或 **Docker** 部署 | `bash <(wget -qO- https://raw.githubusercontent.com/lima-droid/NB-Panel/main/scripts/install2.sh)` |
