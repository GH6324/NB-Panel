...
NPD_DOWNLOAD_URL="https://raw.githubusercontent.com/${GITHUB_REPO}/main/releases/NB-Panel_${NPD_ARCH}-v342.tar.gz"
NPD_LOCAL_TARGZ="${NPD_LOCAL_DIR}/NB-Panel_${NPD_ARCH}-v342.tar.gz"
